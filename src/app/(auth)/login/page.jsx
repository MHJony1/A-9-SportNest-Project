...
const LoginPage = () => {
  ...
  // Google OAuth Social Sign-In Trigger
  ...
  return (
    <div className="w-full min-h-screen bg-transparent text-white flex items-center justify-center px-4 sm:px-6 pt-30 pb-8 relative overflow-hidden">
      ...
      <div className="absolute top-[10%] right-[-5%] w-[300px] h-[300px] rounded-full bg-[#a3e635]/[0.03] blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[10%] left-[-5%] w-[300px] h-[300px] rounded-full bg-[#a3e635]/[0.02] blur-[120px] pointer-events-none" />
      ...
      >
        ...
        <div className="text-center space-y-1">
          ...
          <p className="text-zinc-500 text-[11px] font-semibold">
            Sign in to access your squad bookings & premium pitches.
          </p>
        </div>
